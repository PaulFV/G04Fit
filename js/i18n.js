...
(function (G) {
  ...
  var EN = {
    ...
    'Trizepsdrücken am Kabelzug liegend': 'Lying cable triceps extension', 'Trizepsdrücken am Kabelzug': 'Cable triceps pushdown', 'Trizepsdrücken Langhantel': 'Barbell triceps extension', 'Stirndrücken am Kabelzug': 'Cable skull crusher', 'Kabel-Fliegende (mittlere Brust)': 'Cable fly (mid chest)', 'Beinpresse': 'Leg press', 'Beinstrecker': 'Leg extension', 'Einbeinige Kniebeuge': 'Bulgarian split squat', 'Ausfallschritte (Kurzhanteln)': 'Dumbbell lunge', 'Kreuzheben (Multipresse)': 'Smith machine deadlift', 'Seitheben sitzend': 'Seated lateral raise', 'Fliegende Schrägbank': 'Incline dumbbell fly', 'Frontziehen SZ-Stange': 'Behind-the-back EZ-bar pull', 'Bankdrücken Maschine': 'Machine bench press', 'Frontziehen am Kabelzug': 'Behind-the-back cable pull', 'Klimmzüge Untergriff eng': 'Close-grip chin-up', 'Klimmzüge Maschine kniend': 'Kneeling assisted pull-up machine', 'Reverse Crunches': 'Reverse crunch', 'Criss Cross Crunches': 'Criss-cross crunch', 'Seitbeugen mit Gewicht': 'Weighted side bend', 'Stirndrücken einarmig': 'Single-arm skull crusher', 'Brustpresse (Maschine)': 'Machine chest press', 'Latzugmaschine Obergriff': 'Overhand lat pulldown machine', 'Rudern Maschine Untergriff': 'Underhand machine row', 'Bank-Dips (Trizeps)': 'Bench dip', 'Trizeps-Bankdrücken mit Kurzhanteln': 'Close-grip dumbbell bench press',
