...
(function (G) {
  ...
  var ICONS = {
    ...
    search: '<circle cx="10.8" cy="10.8" r="6.8" fill="none" stroke="currentColor" stroke-width="1.9"/><path d="M16 16l4.2 4.2" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/>',
    filter: '<path d="M4 6h16M7 12h10M10 18h4" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/>',
    muscleChest: '<path d="M12 5c-2.7-2.1-6.8-.6-7.7 2.8-.9 3.7 2.5 7.6 7.7 10.9 5.2-3.3 8.6-7.2 7.7-10.9C18.8 4.4 14.7 2.9 12 5z" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M12 5v13.7M5.4 9.6H12m6.6 0H12" fill="none" stroke="currentColor" stroke-width="1.35"/>',
    muscleBack: '<path d="M8.2 4.5 5.5 8.2l1.2 10.5L12 21l5.3-2.3 1.2-10.5-2.7-3.7L12 6.8 8.2 4.5z" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M12 6.8V19M7 9.5l5 3 5-3" fill="none" stroke="currentColor" stroke-width="1.3"/>',
    muscleShoulders: '<path d="M8 7.2 12 5l4 2.2M8 7.2c-3.2.3-5 2.5-5 5.8M16 7.2c3.2.3 5 2.5 5 5.8M8 7.2 9.5 19h5L16 7.2" fill="none" stroke="currentColor" stroke-width="1.7"/><circle cx="5.4" cy="9.5" r="2.6" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="18.6" cy="9.5" r="2.6" fill="none" stroke="currentColor" stroke-width="1.5"/>',
    muscleBiceps: '<path d="M7 15.5c1.8-1.4 2.3-3.6 2.1-6.5L12 6.4l2 2.1 3.8.4c2.1.2 3.6 2 3.3 4.1-.5 3.8-3.8 6.5-8.4 6.5H7v-4z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M12 6.4V3.5M9.1 9l2.5 2.2" fill="none" stroke="currentColor" stroke-width="1.7"/>',
    muscleTriceps: '<path d="M7 18.5c2-2.3 2.7-4.8 2.2-7.5L7.8 6.8l3-2.3 2.6 3.1 3.8 1.1c2.3.7 3.6 3.1 2.8 5.4-1.1 3.2-4.1 5.4-7.6 5.4H7z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M11 8.2c2.3 1.7 3.5 4 3.4 6.8" fill="none" stroke="currentColor" stroke-width="1.5"/>',
    muscleAbs: '<path d="M8 3.5h8l2 4-1.6 13h-8.8L6 7.5l2-4z" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M12 4v16M7.3 9h9.4M7.8 13h8.4M8.2 17h7.6" fill="none" stroke="currentColor" stroke-width="1.25"/>',
    muscleLegs: '<path d="M8.5 3.5h7l.9 7.4-1.7 3 1 6.6h-3.3l-.9-5.1-.9 5.1H7.3l1-6.6-1.7-3 1.9-7.4z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/><path d="M8.4 10.9h7.2" fill="none" stroke="currentColor" stroke-width="1.25"/>',
    equipment: '<path d="M4 8h16v10H4zM8 8V5h8v3M8 13h8" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/>',
    bodyweight: '<circle cx="12" cy="5" r="2.2" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M12 7.5v6m0-3-4-1.8M12 10.5l4-1.8M12 13.5l-3 6M12 13.5l3 6" fill="none" stroke="currentColor" stroke-width="1.8"/>',
    cable: '<path d="M5 20V4h14v16M8 7h8M9 7l3 8 3-8M10 17h4" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>',
    pullup: '<path d="M4 5h16M6 5v3M18 5v3M12 9v5m0-3-4-2m4 2 4-2m-4 5-3 6m3-6 3 6" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>',
