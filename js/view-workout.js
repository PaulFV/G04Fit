...
(function (G) {
  ...
  var PHOTO_BY_ID = {
    ...
    'row-db': 'row-db', 'deadlift-smith': 'row-bb', 'row-cable': 'row-cable', 'row-machine-underhand': 'row-cable', 'chest-press-machine': 'bench-bb', 'bench-machine': 'bench-bb', 'row-cable-upper': 'row-cable',
